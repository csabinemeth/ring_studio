...
<h5 class="projectTitle">P-22-03_projekt:</h5> <div class="dropdown">
 ...
 <input class="form-control mr-sm-2" id="searchBarDiviziok" type="search" placeholder="Search" aria-label="Search">
 <text class="dateTextDiviziok">2021.12.23 csütörtök</text>
 <div class="dropdown1">
  <button class="btn btn-secondary " type="button" id="plusButtonDiviziok" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  <i class="fas fa-plus"></i>
  </button>
  <div class="dropdown-menu" id="openedDrowdown" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" id="dropdownItem" >Új Divízió</a>
    ...
    <table class="table table-dark" id="diviziokTable">
      <thead>
        ...
        <th><input
            ...
            /></th>
          <th scope="col" class="rendelesTH">Divízió neve</th>
          <th scope="col" class="rendelesTH">Divízió leírása</th>
