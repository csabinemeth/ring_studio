<template>
  <div class="printPage">
    ...
    <h6 class="sumTitle2">Helyszín: Budapest</h6>
     <h5 class="sumTitleTb">BEVÉTELEZÉS ÖSSZESÍTŐ TÁBLÁZAT</h5>
  ...
  <tbody>
    ...
    <div class="compInfoContainer">
     <h6 id="sumCompanyInfoTb">Megrendelő: Ring Studio Kft.</h6> <br/>
     <h6 id="sumCompanyInfoTb2">Cím: 9085 Győr, Bercsényi Liget 26/b</h6><br/>
     <h6 id="sumCompanyInfoTb3">Adószám: 23520451-2-08</h6>
     </div>
    </div>
