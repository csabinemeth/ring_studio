<template>
  <div class="printPage">
    ...
    <h1 class="coverTitle"> Projekt: P-20-14</h1>
     <h5 class="coverTitleAk">AJÁNLATKÉRÉS</h5>
    ...
    <div class="compInfoContainer">
     <h6 id="companyInfo1">Ajánlatkérő: Ring Studio Kft.</h6> <br/>
...
export default {
  ...
  methods: {
    ...
    navToAkContent(){
        this.$router.push("/ajanlatkero_print");
    }, 
    navToAkSum(){
      this.$router.push("ajanlatkeroSum_print");
    }
  },
};
</script>
