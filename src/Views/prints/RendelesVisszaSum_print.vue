<template>
  <div class="printPage">
    ...
    <h6 class="sumTitle2">Helyszín: Budapest</h6>
     <h5 class="sumTitleAk">MEGRENDELÉS VISSZAIGAZOLÓ TÁBLÁZAT</h5>
  ...
  <tbody>
    ...
    <tr>
      <th colspan="3">Bruttó:</th>
      <th>578 313 Ft</th>
    </tr>
  </tbody>
</table>
    <div class="compInfoContainer">
     <h6 id="sumCompanyInfoVr">Szállító: Ring Studio Kft.</h6> <br/>
     <h6 id="sumCompanyInfoVr2">Cím: 9085 Győr, Bercsényi Liget 26/b</h6><br/>
     <h6 id="sumCompanyInfoVr3">Adószám: 23520451-2-08</h6>
     </div>
    </div>
