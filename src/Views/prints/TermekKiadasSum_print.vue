<template>
  <div class="printPage">
    ...
    <h6 class="sumTitle2">Helyszín: Budapest</h6>
     <h5 class="sumTitleTb">SZÁLLÍTÓLEVÉL ÖSSZESÍTŐ TÁBLÁZAT</h5>
  ...
  <tbody>
    ...
    <div class="compInfoContainer">
     <h6 id="sumCompanyInfoTk">Vevő: Ring Studio Kft.</h6> <br/>
     <h6 id="sumCompanyInfoTk2">Cím: 9085 Győr, Bercsényi Liget 26/b</h6><br/>
     <h6 id="sumCompanyInfoTk3">Adószám: 23520451-2-08</h6>
     </div>
    </div>
