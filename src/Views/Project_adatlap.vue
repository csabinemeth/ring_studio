...
<div class="buttonLine">
 <button type="button" id="projectButton" class="btn btn-primary" @click="navDashboard">Dashboard</button>
 <button type="button" id="projectButton" class="btn btn-primary">Projektadatlap</button>
